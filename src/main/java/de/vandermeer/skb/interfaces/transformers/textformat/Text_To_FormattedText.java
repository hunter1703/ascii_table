...
//        final Pattern pattern = Pattern.compile("(\u001B\\[[0-9]+;?m)");
//        final List<StrBuilder> correctBottom = new ArrayList<>();
//        for (final StrBuilder builder : bottom) {
//            final String str = builder.build();
...
//                correctStr += str.substring(l, index);
//                correctStr += (matcher.group(1) + " ");
//                l = matcher.group(1).length() + matcher.start(1);
//            }
//            correctBottom.add(found ? new StrBuilder(correctStr) : builder);
//        }
